...
export const zhMessages = {
  ...
  nav: {
    aria: "浏览路径：项目案例、产品展示、产品选型、增益对比、工具包",
    compare: "增益对比",
    ...
    toolbox: "工具包",
    toolboxHint: "组串核算等工程工具",
    stringCalculator: "组串计算器",
    stringCalculatorHint: "ASHRAE 天气 + IEC 62548 组串 Voc",
  },
  ...
  stringCalc: {
    ...
    subtitle:
      "按项目坐标从 ASHRAE 取极值最低干球温度，用通用法与 IEC 62548-1:2023 F.1.1.b 核算组串 Voc。",
    exportExcel: "导出 Excel（数据核对）",
    exportWord: "导出 Word（报告）",
    exporting: "导出中…",
    exportExcelDone: "已导出 Excel",
    exportWordDone: "已导出 Word 报告",
    exportFailed: "导出失败，请重试",
    stepBadge: "01 / 输入",
    sectionProject: "项目",
    sectionWeather: "天气 · ASHRAE",
    sectionModules: "组件",
    sectionString: "组串与限压",
    clientName: "客户名称",
    projectName: "项目名称",
    location: "地点（Suburb, STATE, Country）",
    coordinates: "坐标（纬度, 经度）",
    coordinatesHint: "例如 -29.0988, 153.0477",
    ashraeVersion: "ASHRAE 版本",
    findStations: "查找最近气象站",
    findingStations: "正在查询…",
    stationsEmpty: "未找到站点，请检查坐标或改为手填。",
    stationsError: "无法连接 ASHRAE，请手填站名与温度。",
    nearestStations: "最近气象站",
    station: "气象站",
    wmo: "WMO",
    distance: "距离",
    period: "资料期",
    tEamdbt: "极值年平均最低干球温度",
    tEamdbtHint:
      "IEC 指定 Extreme Annual Mean Minimum Dry Bulb Temperature，不是湿球、也不是 EPW 年最低气温。",
    tminManual: "已手改温度",
    ashraeLink: "ASHRAE meteo v3.0",
    pickModule: "从组件库选择",
    pickModulePlaceholder: "选择后自动带出 Voc、功率与温度系数",
    customModule: "手填组件",
    addModule: "添加组件",
    removeModule: "移除",
    model: "型号",
    ...
    voc: "Voc STC (V)",
    alphaVoc: "Voc 温度系数 (%/°C)",
    modulesPerString: "每串块数 M",
    voltageLimit: "系统最高电压 (V)",
    resultsBadge: "02 / 结果",
    resultsTitle: "组串 Voc 对照",
    resultsSubtitle: "通用法把 ASHRAE 最低气温当作电池温度；IEC 法再加 10 K。",
    methodGeneral: "通用法",
    ...
    summary: "汇总",
    noModules: "请至少添加一块组件。",
    needTmin: "请填写或查询 Tmin 后再计算。",
    needCoords: "请先填写有效坐标。",
    libraryLongi: "隆基组件库",
    libraryCompetitor: "竞品库",
    isc: "Isc (A)",
    vmp: "Vmp (V)",
    imp: "Imp (A)",
    dimensions: "尺寸",
    fromLibrary: "来自组件库",
    alphaVocDefault: "未入库，使用默认 −0.20 %/°C",
    electricalSpecs: "STC 电参数",
    importPan: "导入 .PAN",
    importingPan: "正在导入…",
    noPanFiles: "未找到 .PAN 文件",
    panImportDone: (ok: number, fail: number) =>
      `已导入 ${ok} 个组件${fail ? `，${fail} 个失败` : ""}`,
    panImportNoVoc: (n: number) =>
      `${n} 个文件缺少 Voc，已入库但无法直接计算组串`,
    panImportHint: "支持一次选择多个 PVsyst .PAN 文件，写入组件库并加入对照",
  },
