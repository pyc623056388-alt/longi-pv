...
export const enMessages: Messages = {
  ...
  nav: {
    aria: "Path: case studies, product showcase, product finder, gain compare, toolkit",
    ...
    toolbox: "Toolkit",
    toolboxHint: "String sizing and other engineering tools",
    stringCalculator: "String Calculator",
    stringCalculatorHint: "ASHRAE weather + IEC 62548 string Voc",
  },
  ...
  stringCalc: {
    eyebrow: "String voltage",
    title: "String Calculator",
    subtitle:
      "Pull ASHRAE extreme annual mean minimum dry-bulb temperature from site coordinates, then check string Voc with the general method and IEC 62548-1:2023 F.1.1.b.",
    exportExcel: "Export Excel (data check)",
    exportWord: "Export Word (report)",
    exporting: "Exporting…",
    exportExcelDone: "Excel exported",
    exportWordDone: "Word report exported",
    exportFailed: "Export failed. Please try again.",
    stepBadge: "01 / Inputs",
    sectionProject: "Project",
    sectionWeather: "Weather · ASHRAE",
    sectionModules: "Modules",
    sectionString: "String & voltage limit",
    clientName: "Client name",
    projectName: "Project name",
    location: "Location (suburb, STATE, country)",
    coordinates: "Coordinates (lat, lon)",
    coordinatesHint: "e.g. -29.0988, 153.0477",
    ashraeVersion: "ASHRAE version",
    findStations: "Find nearest stations",
    findingStations: "Searching…",
    stationsEmpty: "No stations found. Check coordinates or enter values manually.",
    stationsError: "Cannot reach ASHRAE. Enter station name and Tmin manually.",
    nearestStations: "Nearest stations",
    station: "Station",
    wmo: "WMO",
    distance: "Distance",
    period: "Period",
    tEamdbt: "Extreme annual mean min dry-bulb",
    tEamdbtHint:
      "IEC requires Extreme Annual Mean Minimum Dry Bulb Temperature — not wet-bulb, and not EPW annual minimum.",
    tminManual: "Tmin overridden",
    ashraeLink: "ASHRAE meteo v3.0",
    pickModule: "Pick from library",
    pickModulePlaceholder: "Selecting fills Voc, power and αVoc",
    ...
    power: "Power (W)",
    voc: "Voc STC (V)",
    alphaVoc: "Voc temp. coefficient (%/°C)",
    modulesPerString: "Modules per string M",
    voltageLimit: "Max system voltage (V)",
    resultsBadge: "02 / Results",
    resultsTitle: "String Voc comparison",
    resultsSubtitle:
      "General method treats ASHRAE Tmin as cell temperature; IEC adds 10 K.",
    methodGeneral: "General method",
    methodIec: "IEC 62548 F.1.1.b",
    vocString: "String Voc",
    maxM: "Max string length",
    margin: "Headroom vs limit",
    pass: "Within limit",
    fail: "Over limit",
    tUsed: "Temperature used",
    vocModule: "Module Voc(T)",
    ku: "Correction factor K_U",
    uOcArray: "Uncorrected array Voc",
    vsLimit: "Vs voltage limit",
    summary: "Summary",
    noModules: "Add at least one module.",
    needTmin: "Enter or look up Tmin to calculate.",
    needCoords: "Enter valid coordinates first.",
    libraryLongi: "LONGi library",
    libraryCompetitor: "Competitor library",
    isc: "Isc (A)",
    vmp: "Vmp (V)",
    imp: "Imp (A)",
    dimensions: "Dimensions",
    fromLibrary: "From module library",
    alphaVocDefault: "Not in library — using default −0.20 %/°C",
    electricalSpecs: "STC electrical data",
    importPan: "Import .PAN",
    importingPan: "Importing…",
    noPanFiles: "No .PAN files found",
    panImportDone: (ok: number, fail: number) =>
      `Imported ${ok} module${ok === 1 ? "" : "s"}${fail ? `, ${fail} failed` : ""}`,
    panImportNoVoc: (n: number) =>
      `${n} file${n === 1 ? "" : "s"} missing Voc — saved to library but not added to the calculation`,
    panImportHint: "Select one or more PVsyst .PAN files to add them to the library and this comparison",
  },
